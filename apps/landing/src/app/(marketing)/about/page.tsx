    ...
    <div className="overflow-hidden">
      ...
      <section className="bg-[#00BF63] py-16 md:py-24 px-6 md:px-16">
        <div className={CSS_CLASSES.containerMd}>
          <div className="text-center">
            <h1 className={`${CSS_CLASSES.heading1} text-white mb-6 text-4xl md:text-5xl lg:text-6xl`}>
              About ServEase
            </h1>
      ...
      <section className={`bg-white ${CSS_CLASSES.paddingSection}`}>
        <div className={`${CSS_CLASSES.container} grid grid-cols-1 md:grid-cols-2 gap-12`}>
          <div className={`${CSS_CLASSES.cardBase} bg-[#f9f9f9] ${CSS_CLASSES.cardShadow}`}>
            <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 bg-[#00BF63]">
          ...
          <div className={`${CSS_CLASSES.gridCols3} mt-12`}>
            {[
              ...
              <div key={item.step} className={`${CSS_CLASSES.cardBase} bg-white/10 backdrop-blur-sm text-center`}>
                ...
                <div className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-white bg-[#00BF63]">
          ...
          <div className={`${CSS_CLASSES.gridCols3} mt-12`}>
            {[
              ...
              <div key={v.title} className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-4 bg-[#00BF6320]">
