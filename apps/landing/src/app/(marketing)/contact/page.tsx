      ...
      <section className={`bg-white ${CSS_CLASSES.paddingSection}`}>
        <div className={`${CSS_CLASSES.container} grid grid-cols-1 md:grid-cols-2 gap-12`}>
          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((item) => (
                <div key={item.label} className="flex items-start gap-4">
                  <div style={{ backgroundColor: `#00BF6320` }} className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            {/* Map Placeholder */}
            <div className={`${CSS_CLASSES.cardBase} bg-[#f9f9f9] h-64 flex items-center justify-center`}>
              <div className="text-center">
